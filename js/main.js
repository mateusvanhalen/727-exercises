...
//was trying on this code here

// const above19 = integers.reduce((total, amount) => {
//   if (amount > 19) {
//     total.push(above19);
//   }})
// console.log(above19);

let over19 = integers.filter(function(x) {
  return x > 19 && x < 130;
});
console.log(over19);

//trying with MAP high order function - results in true / false

let over19pt2 = integers.map(function(x) { 
  return x > 19;
  });
  console.log(over19pt2);

  //multiplying remaining -- over 19 --- by 1.5

let mult = over19.map(function(num) {
  return num * 1.5;
});
console.log(mult);
